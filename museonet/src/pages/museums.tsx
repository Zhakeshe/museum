...
import type { MuseumRecord } from '../lib/seedMuseums';
...
const MuseumsPage: React.FC = () => {
  ...
  const [museumsData, setMuseumsData] = useState<MuseumRecord[]>([]);
  ...
  const filteredMuseums = useMemo(() => {
    ...
    return items;
  }, [search, region, city, category, price, kids, sort, museumsData]);
